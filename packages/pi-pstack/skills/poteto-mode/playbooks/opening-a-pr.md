...
A subagent that opens a PR runs `interrogate`, `/skill:deslop`, `/skill:unslop`, and `/skill:no-comments`. It returns the URL and does not babysit. Return to the parent.
